# SEO Report Tool — Version 3 Locked Plan
...
**Customer need → Search / AI-powered discovery → Website → Understanding → Trust → Evaluation → Enquiry / Purchase**

Technical SEO supports this path. It is not the centre of the report.

AI search is treated as part of the evolving search ecosystem, not as a separate “AI SEO audit”.

---

# Step 1 — Locked Reporting Specification

## Snapshot V3 — 10 sections
...
Target length: approximately **800–1,100 words**.

## Detailed V3 — 16 sections
...
10. Local Search Readiness — conditional
11. Competitive Search Evidence — conditional / future external data
...
Target length: approximately **1,800–2,600 words**.
...
# Step 3 — External Layer Decision
...
# Step 4 — Locked Evidence Architecture
...
Correct: “No case-study evidence was observed in the pages reviewed.”

Incorrect: “The website has no case studies.”
...
- no automatic “publish blogs every month” advice

---

# Step 6 — Detailed Prompt V3
...
# Step 7 — Snapshot vs Detailed Alignment
...
- Foundation → Growth → Monitor & Improve roadmap
...
# Step 8 — Approved Implementation Plan
...
**Crawler → Evidence Package → AI generators → Prompts → Parser → Types → Report UI → PDF → Admin Prompt Validation → Archived Reports**
...
14. Run full workflow test: URL → Snapshot → Detailed → PDF → Archive → Admin
...
The current PDF label “AI SEO Advisory Report” should be reconsidered for V3 because the product is not positioned as an AI-only SEO audit.
...
**URL → Snapshot → Detailed → PDF → Archive → Admin → Rating**

---

# Current Status / Next Action

Steps 1–8 are approved conceptually.
