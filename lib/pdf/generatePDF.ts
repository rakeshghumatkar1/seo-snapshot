...
<head>
<meta charset="UTF-8">
<title>SEO Report — ${escapeHtml(data.websiteUrl)}</title>
<style>
...
<body>
  <div class="header">
    <div class="header-top">
      ...
      <div class="report-badge">${escapeHtml(data.reportType.toUpperCase())} REPORT</div>
    </div>
    <div class="website-url">${escapeHtml(data.websiteUrl)}</div>
    <div class="report-meta">Generated on ${escapeHtml(date)} &middot; AI SEO Advisory Report</div>
  </div>
  ${sectionsHTML}
  <div class="footer">Generated by SEO AI &middot; ${escapeHtml(data.websiteUrl)} &middot; ${escapeHtml(date)}</div>
</body>
</html>`
}
